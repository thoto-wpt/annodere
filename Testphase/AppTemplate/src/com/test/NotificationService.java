		...
		if (event.getEventType() == AccessibilityEvent.TYPE_NOTIFICATION_STATE_CHANGED) 
	      {
			Notification notification = (Notification) event.getParcelableData();
			  ...
			  /*// Unwichtige, aber interessante Details:
			  ...
			  */
			  ...
			  //System.out.println(notificationList); // Möglichkeiten über Möglichkeiten ...
			 
			
			  System.out.println(notification); // So sieht die normale, nicht geparste Version aus.
